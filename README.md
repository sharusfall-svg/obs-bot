...
- **Авто-сцена** — автоматическое переключение основная/перерыв по битрейту входящего SRT-потока (MediaMTX), с порогами и гистерезисом; вкл/выкл кнопкой «🔄 Авто-сцена»
